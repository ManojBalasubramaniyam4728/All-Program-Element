...
@Component("LIC14333_PJT1001_PE_NLPf6dfc033-9748-4aaf-83f1-ae62b684c083")
public class MOB_Get_Coordinate_From_The_Bounds_Value implements Nlp {
    @InputParams({@InputParam(name = "BoundsValue", type = "java.lang.String"),
    	         @InputParam(name = "XorYCoordinate", type = "java.lang.String"),
    	         @InputParam(name = "Percent", type = "java.lang.String")})
         ...
         NlpResponseModel nlpResponseModel = new NlpResponseModel();
          ...
          try {
        		    	...
        		    	ArrayList<Integer> list=new ArrayList<Integer>();
        		          ...
        		          else if(XorYCoordinate.equalsIgnoreCase("fullx")) {
        		        	  int x=(int) ((list.get(0)+list.get(2))*(Double.parseDouble(Percent)));
        		        	  Coordinates=x+"";
        		          }
        		          else if(XorYCoordinate.equalsIgnoreCase("fully")) {
        		        	  int y=(int) ((list.get(1)+list.get(3))*(Double.parseDouble(Percent)));
        		        	  Coordinates=y+"";
        		          }
