...
@Component("LIC1002_PJT1016_PE_NLP90da1848-5e8d-4b2e-8498-2a23a5d3f92f")
public class IOS_WhileLoopForWaitUntilTheElementIsPresentInTheDOMAndClickAndReturnTheOrderOfPopUps implements Nlp {
	...
	public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		try {
			...
			IOSDriver driver = nlpResponseModel.getIosDriver();
